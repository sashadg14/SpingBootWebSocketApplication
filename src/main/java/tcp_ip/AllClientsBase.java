...
public class AllClientsBase {
    private Map<AbstractSocket, String> usersMap = new LinkedHashMap<>();
    private List<AbstractSocket> waitingUsersList = new LinkedList<>();

    private Map<AbstractSocket, String> agentsMap = new LinkedHashMap<>();
    private List<AbstractSocket> freeArentsList = new LinkedList<>();
    ...
    public void addUserChannelInWaiting(AbstractSocket channel) {
       // System.out.println(getClientNameByChanel(channel)+"========================================");
        waitingUsersList.add(channel);
        ServerCommunication.getInstance().tryToCreateNewPair();
    }
